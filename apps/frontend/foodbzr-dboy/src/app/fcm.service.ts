...
export class FcmService {
    ...
    constructor(private router: Router, private toast: ToastController, private platform: Platform, private loading: LoadingScreenService) {
        this.entity_row_uuid = localStorage.getItem('dboy_row_uuid');
    }
    ...
    private saveToDB(key: string) {
        this.platform.ready().then(async () => {
            ...
            (await insert_push_message__.fetch('dboy', this.entity_row_uuid, key)).obsData();
            daoLife.softKill();
        });
    }
