...
export class UpdateMenuComponent implements OnInit {
    ...
    updateMenuDetails() {
        ...
        update_menu__.observe(daoLife).subscribe((val) => console.log('updated the menu'));
    ...
    updateFoodCat() {
        ...
        update_menu_category__.observe(daoLife).subscribe((val) => console.log('updated the food cat'));
    ...
    updateMenuOffer() {
        ...
        update_menu_offers__.observe(daoLife).subscribe((val) => console.log('updated the menu offers'));
