...
export class AddFoodCatComponent {
    @Input() database: {
        insert_food_category: databaseDao<insert_food_category>;
    };
    ...
    public saveFoodCat() {
        ...
        this.platform.ready().then(() => {
            ...
            this.loading.showLoadingScreen().then(() => {
                insert_food_category__.fetch(this.food_cat_name, null, this.owner_row_uuid, this.offer_percentage, offer_start_datetime, offer_end_datetime, date_created, uuid()).obsData();
            });
