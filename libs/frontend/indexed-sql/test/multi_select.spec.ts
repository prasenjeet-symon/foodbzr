import { insert_data } from '../src/lib/single-table/insert_data';
import { create_table } from '../src/lib/table-modification/create_table';
import {
...
} from '../src/lib/multiple-table/multi_select';
import { make_select_literals } from '../src/lib/single-table/select_clause';
import { setup_initial_config_tables } from '../src/lib/utils';
...
describe('multi_select/multiple_select', () => {
  ...
  test('perform multi query', async () => {
    ...
    const result = await multiple_select(query, 'test_database_one');
    expect(1).toBe(1);
  });
});
